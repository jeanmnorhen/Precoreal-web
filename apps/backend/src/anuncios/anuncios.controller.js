...
let AnunciosController = (() => {
    let _classDecorators = [(0, common_1.Controller)('anuncios'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var AnunciosController = class {
        ...
        static {
            ...
            AnunciosController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        anunciosService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return AnunciosController = _classThis;
})();
