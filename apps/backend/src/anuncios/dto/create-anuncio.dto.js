...
let CreateAnuncioDto = (() => {
    ...
    return class CreateAnuncioDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _produtoId_decorators = [(0, class_validator_1.IsString)()];
            ...
            _raioAlcanceKm_decorators = [(0, class_validator_1.IsNumber)()];
            _custoCreditos_decorators = [(0, class_validator_1.IsNumber)()];
            _dataInicio_decorators = [(0, class_validator_1.IsDateString)()];
            _dataFim_decorators = [(0, class_validator_1.IsDateString)()];
        ...
        constructor() {
            __runInitializers(this, _dataFim_extraInitializers);
        }
    };
})();
