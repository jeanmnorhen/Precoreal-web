...
let RegisterDto = (() => {
    ...
    return class RegisterDto {
        static {
            ...
            _senha_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(6)];
            _tipo_decorators = [(0, class_validator_1.IsEnum)(['consumidor', 'lojista'])];
        ...
        senha = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _senha_initializers, void 0));
        tipo = (__runInitializers(this, _senha_extraInitializers), __runInitializers(this, _tipo_initializers, void 0));
        constructor() {
