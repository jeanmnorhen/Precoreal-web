...
let StripeController = (() => {
    let _classDecorators = [(0, common_1.Controller)('stripe')];
    ...
    var StripeController = class {
        ...
        static {
            ...
            __esDecorate(this, null, _webhook_decorators, { kind: "method", name: "webhook", static: false, private: false, access: { has: obj => "webhook" in obj, get: obj => obj.webhook }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async webhook(signature, request) {
