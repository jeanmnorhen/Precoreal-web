        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm sm:text-base mt-3 max-w-md leading-relaxed"
            ...
            <div className="flex gap-3 flex-shrink-0">
              <Link href="/scanner"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-md"
                    style={{
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.title}
                   className="p-5 rounded-xl transition-all duration-200 hover:shadow-sm animate-fade-in-up"
                   style={{
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="gradient-navy rounded-2xl p-10 sm:p-14 shadow-xl animate-scale-in">
            ...
            <Link href="/scanner"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                  style={{
                    background: '#fff',
